...
\paragraph{}
The operating system on the Death Star server was Ubuntu 14.04 LTS, which is due to stop recieving security updates in April 2019.
Because of this, it is imperative that the operating system is upgraded to a new version.
I would recommend installing Ubuntu 18.04 LTS,  which will recieve security updates untill 2023.
...
\paragraph{}
During my investigation, I found a questionable Ruby script in the \texttt{/home/darth_vader} folder, implying that they were created by this user.
Upon analysing the contents of the file, it appears to perform an SQL-injection attack on the Death Star's payroll app.
All of this implies that there is a rogue employee of the Empire using the Death Star server.
\emph{This cannot be ignored and must be investigated.} 
